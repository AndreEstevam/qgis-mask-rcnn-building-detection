# -*- coding: utf-8 -*-
"""Mask_RCNN_Torch_inference.ipynb

Automatically generated by Colaboratory. Modified to work as a standalone script.

Highly recommended to check the original file located at:
    https://colab.research.google.com/drive/1Y0vPWkxLz62-JyGkUkbczTqRqEXefeyn
...
def get_model_instance(backbone="resnet50+fpn", trainable_layers=0):
    """
    Instanciate a mask-rcnn model with the given backbone for detecting edfication;
    Defaults to only heads as trainable layers;
    Args:
        - backbone: "resnet50+fpn" or "resnet101+fpn";
        - trainable_layers: trainable bakcbone layers, been between 0 and 5, where 
        5 means all layers as trainable and 0 only heads;
    Returns:
        A model instance;
...
def get_inference(weights_path, img_np, threshold):
    ...
    Args:
        ...
        - threshold: minimum probability for the detection to contain a building;
    Returns:
